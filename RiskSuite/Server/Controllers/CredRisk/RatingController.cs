...
namespace LogSuite.Server.Controllers.References
{
    ...
    public class RatingController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromBody] RatingDTO dto, int? id)
        {
            ...
            else
            {
                return BadRequest(new ErrorModel()
                {
                    ErrorMessage = "Error while updating Rating"
                });
            }
        }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            if (result == -1)
            {
                ...
                {
                    Title = "",
                    ErrorMessage = "Can't delete Rating with rates assigned",
