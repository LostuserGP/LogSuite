...
namespace LogSuite.DataAccess.Migrations
{
    ...
    [Migration("20210909145113_addGisInputAndOutput")]
    partial class addGisInputAndOutput
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogSuite.DataAccess.Operativka.Gis", b =>
                {
                    ...
                    b.Property<int>("GisInputId")
                        .HasColumnType("integer")
                        .HasColumnName("gis_input_id");

                    b.Property<int>("GisOutputId")
                        .HasColumnType("integer")
                        .HasColumnName("gis_output_id");
            ...
            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisInput", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_gis_inputs");

                    b.HasIndex("GisId")
                        .IsUnique()
                        .HasDatabaseName("ix_gis_inputs_gis_id");

                    b.ToTable("gis_inputs");
                });

            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisInputName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("GisInputId")
                        .HasDatabaseName("ix_gis_input_names_gis_input_id");

                    b.ToTable("gis_input_names");
                });

            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisInputValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("GisInputId")
                        .HasDatabaseName("ix_gis_input_values_gis_input_id");
            ...
            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisOutput", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_gis_outputs");

                    b.HasIndex("GisId")
                        .IsUnique()
                        .HasDatabaseName("ix_gis_outputs_gis_id");

                    b.ToTable("gis_outputs");
                });

            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisOutputName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("GisOutputId")
                        .HasDatabaseName("ix_gis_output_names_gis_output_id");

                    b.ToTable("gis_output_names");
                });

            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisOutputValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("GisOutputId")
                        .HasDatabaseName("ix_gis_output_values_gis_output_id");
            ...
            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisInput", b =>
                {
                    b.HasOne("LogSuite.DataAccess.Operativka.Gis", "Gis")
                        .WithOne("GisInput")
                        .HasForeignKey("LogSuite.DataAccess.Operativka.GisInput", "GisId")
                        .HasConstraintName("fk_gis_inputs_gises_gis_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisInputName", b =>
                {
                    b.HasOne("LogSuite.DataAccess.Operativka.GisInput", "GisInput")
                        .WithMany("Names")
                        .HasForeignKey("GisInputId")
                        .HasConstraintName("fk_gis_input_names_gis_inputs_gis_input_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GisInput");
                });
            ...
            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisInputValue", b =>
                {
                    ...
                    b.HasOne("LogSuite.DataAccess.Operativka.GisInput", "GisInput")
                        .WithMany("Values")
                        .HasForeignKey("GisInputId")
                        .HasConstraintName("fk_gis_input_values_gis_inputs_gis_input_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisOutput", b =>
                {
                    b.HasOne("LogSuite.DataAccess.Operativka.Gis", "Gis")
                        .WithOne("GisOutput")
                        .HasForeignKey("LogSuite.DataAccess.Operativka.GisOutput", "GisId")
                        .HasConstraintName("fk_gis_outputs_gises_gis_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisOutputName", b =>
                {
                    b.HasOne("LogSuite.DataAccess.Operativka.GisOutput", "GisOutput")
                        .WithMany("Names")
                        .HasForeignKey("GisOutputId")
                        .HasConstraintName("fk_gis_output_names_gis_outputs_gis_output_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GisOutput");
                });
            ...
            modelBuilder.Entity("LogSuite.DataAccess.Operativka.GisOutputValue", b =>
                {
                    ...
                    b.HasOne("LogSuite.DataAccess.Operativka.GisOutput", "GisOutput")
                        .WithMany("Values")
                        .HasForeignKey("GisOutputId")
                        .HasConstraintName("fk_gis_output_values_gis_outputs_gis_output_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
