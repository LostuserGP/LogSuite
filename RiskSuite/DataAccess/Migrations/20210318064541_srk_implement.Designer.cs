...
namespace RiskSuite.DataAccess.Migrations
{
    ...
    [Migration("20210318064541_srk_implement")]
    partial class srk_implement
    {
            ...
            modelBuilder.Entity("RiskSuite.DataAccess.CredRisk.RatingGroup", b =>
                {
                    ...
                    b.Property<long>("GLimit")
                        .HasColumnType("bigint")
                        .HasColumnName("g_limit");

                    b.Property<long>("GLimitBank")
                        .HasColumnType("bigint")
                        .HasColumnName("g_limit_bank");
