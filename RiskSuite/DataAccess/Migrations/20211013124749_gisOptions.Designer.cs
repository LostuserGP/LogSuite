...
namespace LogSuite.DataAccess.Migrations
{
    ...
    [Migration("20211013124749_gisOptions")]
    partial class gisOptions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.Gis", b =>
                {
                    ...
                    b.Property<bool>("NoPhg")
                        .HasColumnType("boolean")
                        .HasColumnName("no_phg");

                    b.Property<bool>("ShowOnBottom")
                        .HasColumnType("boolean")
                        .HasColumnName("show_on_bottom");

                    b.Property<bool>("ShowOnTop")
                        .HasColumnType("boolean")
                        .HasColumnName("show_on_top");
            ...
            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.GisAddonName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.GisInputName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_gis_input_names");

                    b.HasIndex("GisId")
                        .HasDatabaseName("ix_gis_input_names_gis_id");

                    b.ToTable("gis_input_names");
                });
            ...
            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.GisInputValue", b =>
                {
                    ...
                    b.HasIndex("GisId")
                        .HasDatabaseName("ix_gis_input_values_gis_id");

                    b.HasIndex("RequestedValueTimeId")
                        .HasDatabaseName("ix_gis_input_values_requested_value_time_id");

                    b.ToTable("gis_input_values");
                });

            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.GisName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.GisOutputName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_gis_output_names");

                    b.HasIndex("GisId")
                        .HasDatabaseName("ix_gis_output_names_gis_id");

                    b.ToTable("gis_output_names");
                });
            ...
            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.GisOutputValue", b =>
                {
                    ...
                    b.HasIndex("GisId")
                        .HasDatabaseName("ix_gis_output_values_gis_id");

                    b.HasIndex("RequestedValueTimeId")
                        .HasDatabaseName("ix_gis_output_values_requested_value_time_id");

                    b.ToTable("gis_output_values");
                });
            ...
            modelBuilder.Entity("LogSuite.DataAccess.References.FileTypeSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.GisInputName", b =>
                {
                    b.HasOne("LogSuite.DataAccess.DailyReview.Gis", "Gis")
                        .WithMany("GisInputNames")
                        .HasForeignKey("GisId")
                        .HasConstraintName("fk_gis_input_names_gises_gis_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.GisOutputName", b =>
                {
                    b.HasOne("LogSuite.DataAccess.DailyReview.Gis", "Gis")
                        .WithMany("GisOutputNames")
                        .HasForeignKey("GisId")
                        .HasConstraintName("fk_gis_output_names_gises_gis_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LogSuite.DataAccess.DailyReview.Gis", b =>
                {
                    ...
                    b.Navigation("GisInputNames");

                    b.Navigation("GisInputValues");

                    b.Navigation("GisOutputNames");
