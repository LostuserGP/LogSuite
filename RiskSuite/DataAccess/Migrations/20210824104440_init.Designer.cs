            ...
            modelBuilder.Entity("LogSuite.DataAccess.References.CountryName", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_country_name");

                    b.HasIndex("CountryId")
                        .HasDatabaseName("ix_country_name_country_id");

                    b.ToTable("country_name");
                });
            ...
            modelBuilder.Entity("LogSuite.DataAccess.References.CountryName", b =>
                {
                    b.HasOne("LogSuite.DataAccess.References.Country", "Country")
                        .WithMany("Names")
                        .HasForeignKey("CountryId")
                        .HasConstraintName("fk_country_name_countries_country_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
