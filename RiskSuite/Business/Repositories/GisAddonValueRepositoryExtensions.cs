...
{
    public static class GisAddonValueRepositoryExtensions
    {
        public static IQueryable<GisAddonValue> Search(this IQueryable<GisAddonValue> source, string filter)
        {
        ...
        public static IQueryable<GisAddonValue> Sort(this IQueryable<GisAddonValue> source, string columnName, bool ascendind)
        {
