...
namespace Business.Repositories
{
    public class GisAddonValueRepository : IGisAddonValueRepository
    {
        ...
        public async Task<List<GisAddonValueDTO>> GetOnDateRangeByGisAddonId(int gisAddonId, DateTime startDate, DateTime finishDate)
        {
        ...
        public async Task<object> Update(GisAddonValueDTO dto)
        {
            var fromDb = await _db.GisAddonValues
                .Include(x => x.RequestedValueTime)
                .Include(x => x.AllocatedValueTime)
