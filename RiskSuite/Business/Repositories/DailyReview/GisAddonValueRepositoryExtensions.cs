...
namespace LogSuite.Business.Repositories.DailyReview
{
    ...
    {
        public static IQueryable<IDayValue> Search(this IQueryable<IDayValue> source, string filter)
        {
        ...
        public static IQueryable<IDayValue> Sort(this IQueryable<IDayValue> source, string columnName, bool @ascending)
        {
