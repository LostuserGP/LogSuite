...
namespace LogSuite.Client.Services
{
    public class GisOutputValueService : IGisOutputValueService
    {
        ...
        private readonly string _apirUrl = "api/gisoutputvalue";

        public GisOutputValueService(HttpClient client, ToastService toastService)
        {
            _client = client;
        ...
        public async Task<IEnumerable<GisOutputValueDTO>> GetOnDateRangeByGisId(int gisId, DateTime dateStart, DateTime dateEnd)
        {
            var queryStringParam = new Dictionary<string, string>
            {
