...
namespace LogSuite.Client.Services
{
    public class CountryService : ICountryService
    {
        ...
        private readonly string _apirUrl = "api/references/country";

        public CountryService(HttpClient client, ToastService toastService)
        {
            _client = client;
        ...
        public async Task<PagingResponse<CountryDTO>> Getall(Params parameters)
        {
            ...
            {
                Items = System.Text.Json.JsonSerializer.Deserialize<List<CountryDTO>>(content, new JsonSerializerOptions { PropertyNameCaseInsensitive = true }),
