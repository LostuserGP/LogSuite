...
{
    public partial class GisDetail
    {
        ...
        private async Task HandleSubmit()
        {
            try
            {
                ...
                if (GisNameModel.Id > 0)
                {
                    ...
                    if (result != null)
                    {
                        toastService.ShowToast("Наименование ГИС успешно обновлено", ToastLevel.Success);
                    }
                }
                else
                {
                    ...
                    if (result != null)
                    {
                        toastService.ShowToast("Наименование ГИС успешно создано", ToastLevel.Success);
                    }
                }
            }
            catch (Exception e)
