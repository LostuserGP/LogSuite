...
namespace LogSuite.Client.Pages.DailyReview
{
    ...
    public partial class DailyReviewInput
    {
        ...
        private IEnumerable<GisInputValueDTO> valueList;
        ...
        {
            EditMode = "new";
            Model = new GisInputValueDTO();
        }

        private void Edit(GisInputValueDTO value)
        {
            Model = value;
            EditMode = "edit";
        }
