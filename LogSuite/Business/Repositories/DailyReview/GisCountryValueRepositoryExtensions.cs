...
{
    public static class GisCountryValueRepositoryExtensions
    {
        public static IQueryable<GisCountryValue> Search(this IQueryable<GisCountryValue> source, string filter)
        {
        ...
        public static IQueryable<GisCountryValue> Sort(this IQueryable<GisCountryValue> source, string columnName, bool @ascending)
        {
