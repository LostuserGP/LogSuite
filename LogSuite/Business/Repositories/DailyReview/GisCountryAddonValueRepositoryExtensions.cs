...
{
    public static class GisCountryAddonValueRepositoryExtensions
    {
        public static IQueryable<GisCountryAddonValue> Search(this IQueryable<GisCountryAddonValue> source, string filter)
        {
        ...
        public static IQueryable<GisCountryAddonValue> Sort(this IQueryable<GisCountryAddonValue> source, string columnName, bool @ascending)
        {
