...
namespace LogSuite.Business.Mapper
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<InputFileLogDTO, InputFileLog>()
                ...
                .ForMember(dest => dest.FileTime, opts => opts.MapFrom(src => src.FileTime))
                .ForMember(dest => dest.InputTime, opts => opts.MapFrom(src => src.InputTime))
                .ForMember(dest => dest.FileDate, opts => opts.MapFrom(src => src.FileDate));
            ...
            CreateMap<GisCountryAddon, GisCountryAddonDto>().ReverseMap();
            CreateMap<GisCountryAddonType, GisCountryAddonTypeDto>().ReverseMap();
            CreateMap<GisCountryAddonValue, GisCountryAddonValueDto>().ReverseMap();
        }
    }
}
