...
using System;
using System.Text;
using LogSuite.Business.Repositories.CredRisk;
using LogSuite.Business.Repositories.CredRisk.References;
...
namespace LogSuite.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IGisCountryAddonRepository, GisCountryAddonRepository>();
            services.AddScoped<IGisCountryAddonTypeRepository, GisCountryAddonTypeRepository>();
            services.AddScoped<IGisCountryAddonValueRepository, GisCountryAddonValueRepository>();
